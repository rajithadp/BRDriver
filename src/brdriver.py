...
layout = [
	[sg.Text('Chromosome Number',size=(30, 1),justification='right',font=("Times New Roman",20),text_color='Black',background_color='White'), sg.InputText('10',key='-Chr-',size=(10, 1),text_color='Black',background_color='White')],
	[sg.Text('Chromosomal Position',size=(30, 1),justification='right',font=("Times New Roman",20),text_color='Black',background_color='White'), sg.InputText('8073911',key='-Pos-',size=(10, 1),text_color='Black',background_color='White')],
    [sg.Text('Reference Allele',size=(30, 1),justification='right',font=("Times New Roman",20),text_color='Black',background_color='White'), sg.InputText('-',key='-Ref-',size=(10, 1),text_color='Black',background_color='White')],
    [sg.Text('Alternative Allele',size=(30, 1),justification='right',font=("Times New Roman",20),text_color='Black',background_color='White'), sg.InputText('A',key='-Alt-',size=(10, 1),text_color='Black',background_color='White')],
